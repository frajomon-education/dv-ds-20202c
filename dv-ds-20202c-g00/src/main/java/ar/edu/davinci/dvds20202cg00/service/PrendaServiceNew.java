...
@Service
public class PrendaServiceNew {
	
	private final Logger LOGGER = LoggerFactory.getLogger(PrendaServiceNew.class);

	private final PrendaRepository prendaRepository;
	
	@Autowired
	public PrendaServiceNew(final PrendaRepository prendaRepository) {
